...
public class FrmRecommendOrder extends JDialog implements ActionListener{
	...
	public FrmRecommendOrder(FrmCommend_Menu frmCommend_Menu, String s, boolean b) {
		super(frmCommend_Menu, s, b);
