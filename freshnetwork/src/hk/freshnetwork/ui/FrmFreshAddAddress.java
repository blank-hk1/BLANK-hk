...
public class FrmFreshAddAddress extends JDialog implements ActionListener{
	private JPanel toolBar = new JPanel();
	private JPanel workPane = new JPanel();
	
	private JButton btnOk = new JButton("添加配送地址");
	...
	public FrmFreshAddAddress(FrmChooseAddress frmChooseAddress, String s, boolean b) {
		super(frmChooseAddress, s, b);
